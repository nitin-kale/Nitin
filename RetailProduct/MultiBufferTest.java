...
public class MultiBufferTest {
	...
	private static DisplayMode[] BEST_DISPLAY_MODES = new DisplayMode[] { new DisplayMode(1200, 800, 32, 0),
			new DisplayMode(1200, 800, 16, 0), new DisplayMode(1200, 800, 8, 0) };
	...
	public static void main(String[] args) {
		try {
			...
			Rectangle bd = env.getMaximumWindowBounds();
			new General().msg("Bounds is" + bd);

			GraphicsDevice device = env.getDefaultScreenDevice();
			new General().msg("Device is" + device);
