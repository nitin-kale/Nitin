...
public class ApplicationMenu extends gnPublicVariable {

	public static JFrame ApplicationFrameMenu;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ApplicationMenu window = new ApplicationMenu();
					window.ApplicationFrameMenu.setVisible(true);
	...
	public ApplicationMenu() throws Throwable {
		initialize();
	}
	...
	private void initialize() throws Throwable {
		...
		ApplicationFrameMenu = new JFrame();
		ActionListener sl = new menulsnr();
		ApplicationFrameMenu.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
		// ApplicationFrameMenu.setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\AKN\\myProductImage\\mretoo6.png"));
		ApplicationFrameMenu.getContentPane().setBackground(new Color(255, 0, 153));
		ApplicationFrameMenu.setBackground(new Color(0, 0, 102));
		ApplicationFrameMenu.setResizable(false);
		ApplicationFrameMenu.setBounds(0, 0, 1360, 775);
		ApplicationFrameMenu.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		base = (JComponent) ApplicationFrameMenu.getContentPane();
		// String compName = new gnConfig().getCompany();
		String compName = "...";
		ActionListener ls1 = new menulsnr();
		ApplicationFrameMenu.getContentPane().setLayout(null);
		...
		ApplicationFrameMenu.getContentPane().add(menuStoreOps);
		...
		JMenu Article = new JMenu("Article View");
		...
		JMenu mnGr = new JMenu("Goods Receive");
		mnGr.setMnemonic('g');
		...
		JMenuItem shelftalker = new JMenuItem("Print ShelfTalkers");
		...
		btnImage.setSelectedIcon(new ImageIcon(ApplicationMenu.class.getResource("/RetailProduct/mymainlogo_4.png")));
		...
		ApplicationFrameMenu.getContentPane().add(btnImage);
		...
		ApplicationFrameMenu.getContentPane().add(btn1001);
		sfromat = new JTextField();
		sfromat.setBounds(934, 204, 116, 22);
		ApplicationFrameMenu.getContentPane().add(sfromat);
		sfromat.setColumns(10);
		JPanel panel10 = new JPanel();
		panel10.setBounds(0, 583, 1360, 92);
		ApplicationFrameMenu.getContentPane().add(panel10);
		...
		ApplicationFrameMenu.getContentPane().add(btn1002);
		...
		ApplicationFrameMenu.getContentPane().add(btn1003);
		...
		ApplicationFrameMenu.getContentPane().add(btn1004);
	...
	private void setStyleofmybuttons() {
		...
		ApplicationFrameMenu.getContentPane().add(lblNewLabel);
	...
	public void decorate() throws Throwable {
		...
		new gnApplicationSetting().setAppDesign(ApplicationFrameMenu, gnPublicVariable.compcode,
		...
		switch (vthemeType) {
		case "Theme1":
			new gnApp().setLAF(ApplicationFrameMenu, LAF);
			break;
		default:
			new gnApp().setLAF(ApplicationFrameMenu, LAF);
			break;
	...
	private void setOnlyForAdmin() {
		...
		case "ADMIN":
			...
			mnSales.setVisible(true);
			menuSalereturn.setVisible(true);
			menuPurchasereturn.setVisible(true);
	 		menuSalesOrder.setVisible(true);
	 		GRNWITHBOX.setVisible(true);
	 		mnProduction.setVisible(true);
	  		helpmodule.setVisible(true);
			dynamicMbq.setVisible(true);
			purchaseInfoRecord.setVisible(true);
			mnSOview.setVisible(true);
	 		payrecpt.setVisible(true);
			menuAccounting.setVisible(true);
	...
	private void activeToolBar() {
		...
		ApplicationFrameMenu.getContentPane().add(toolBar);
